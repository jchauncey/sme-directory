 ...
 *
 * The `sme_csrf` cookie is issued by the proxy on the first request that
 ...
 * server actions). The proxy enforces the header check on POST/PATCH/
 ...
 * (proxy) and the Node runtime (route handlers, server actions, RSC) can
